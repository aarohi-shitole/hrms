...
/**
 * Criteria class for the {@link com.techvg.hrms.domain.SecurityRole} entity. This class is used
 * in {@link com.techvg.hrms.web.rest.SecurityRoleResource} to receive all the possible filtering options from
...
public class SecurityRoleCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, roleName, description, lastModified, lastModifiedBy, securityPermissionId, employeeId, distinct);
    }
