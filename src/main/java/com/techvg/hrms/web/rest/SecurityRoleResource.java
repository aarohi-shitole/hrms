...
import com.techvg.hrms.service.SecurityRoleQueryService;
...
/**
 * REST controller for managing {@link com.techvg.hrms.domain.SecurityRole}.
 */
@RestController
@RequestMapping("/api")
public class SecurityRoleResource {
    ...
    public ResponseEntity<SecurityRoleDTO> updateSecurityRole(
        ...
        SecurityRoleDTO result = securityRoleService.update(securityRoleDTO);
        return ResponseEntity
            .ok()
