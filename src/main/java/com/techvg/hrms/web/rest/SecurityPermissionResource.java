...
import com.techvg.hrms.service.SecurityPermissionQueryService;
import com.techvg.hrms.service.SecurityPermissionService;
...
/**
 * REST controller for managing {@link com.techvg.hrms.domain.SecurityPermission}.
 */
@RestController
@RequestMapping("/api")
public class SecurityPermissionResource {
    ...
    public ResponseEntity<SecurityPermissionDTO> updateSecurityPermission(
        ...
        SecurityPermissionDTO result = securityPermissionService.update(securityPermissionDTO);
        return ResponseEntity
            .ok()
